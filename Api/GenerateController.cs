...
namespace QuiptMappingEngine.Api
{
    ...
    public class GenerateController : ControllerBase
    {
        ...
        public IActionResult Generate([FromBody] GenerateRequest request)
        {
            ...
            var groundTruthByCanon = EvaluationService.IndexGroundTruthByCanonKey(groundTruth);
            ...
            var gtAccuracy = report.GroundTruthAccuracyPercent;
            ...
            foreach (var m in mappings)
            {
                ...
                // Check against ground truth (canonical keys: item_weight ↔ itemWeight)
                if (EvaluationService.TryGetGroundTruthPath(groundTruthByCanon, m.AmazonField, out var expected))
                {
            ...
            var response = new ApiResponseModel
            {
                ...
                GroundTruthAccuracy = Math.Round(gtAccuracy, 2),
                FieldsWithGroundTruth = report.FieldsWithGroundTruth,
                WrongAmongGroundTruth = report.WrongAmongGroundTruth,
                MissingAmongGroundTruth = report.MissingAmongGroundTruth,
